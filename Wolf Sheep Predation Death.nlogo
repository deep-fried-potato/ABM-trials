...
to go
  ...
  ask sheep [
    ...
    if model-version = "sheep-wolves-grass" [
      ...
      age-and-death ; sheep die from starvation only if running the sheep-wolves-grass model version
    ]
  ...
  ask wolves [
    ...
    age-and-death ; wolves die if they run out of energy
...
to age-and-death  ; turtle procedure (i.e. both wolf and sheep procedure)
